    ...
    <div class="ztinfo-insurance" id="export_insurance">
      ...
      <table class="insurance-table1" border="1">
        ...
        <tr>
          <td>
            ...
            >年，自设备安装之日起生效，在保险期间内如发生车辆转让，保险责任终止；车辆所有人或管理人应及时通知昌篮（石家庄）科技有限公司变更手续，手续变更次日零时保险责任恢复，否则保险人不承担赔偿责任。保险期限：
      ...
      <div class="new-content">
        ...
        <div class="foot-content">
          ...
          <p>4、以上特别约定由昌蓝（石家庄）科技有限公司先行赔付。</p>
          <p>5、昌蓝（石家庄）科技有限公司凭有效单据向保险公司索赔。</p>
          <p>
            6、盗抢保障服务费：<span
              class="underline"
  ...
  methods: {
    ...
    exportInsurance() {
      ...
      ExportUtil.exportPdf(
        ...
        this.imei + "_昌蓝服务单-含购置税(" + this.policy.policyId + ")"
      );
      setTimeout(() => {
