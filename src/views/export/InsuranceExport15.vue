  ...
  <section style="text-align:center;">
    ...
    <div class="ztinfo-insurance" id="export_insurance">
      <div class="insurance-header">
        ...
        <div class="tab-item">
          <span>保单号：6615402021130194000005</span>
      ...
      <div style="margin:8px 0">
        请您准确、完整的填写摩托车盗抢综合保险客户服务单表格列明的信息，并对填写真实有效性负责，否则，由此产生的责任将由您自行承担。
      </div>
      <table class="insurance-table1" border="1">
        ...
        <tr>
          <td>
            <span>保障范围：</span
            >凡在中华人民共和国境内安装了昌蓝（石家庄）科技有限公司销售的北斗/GPS智能车载终端的车辆，该车辆必须手续齐全，合法有效。
          </td>
        </tr>
        <tr>
          <td>
            <span
              >保险期限：<span class="underline">{{ yearXian }}</span></span
            >年，自设备安装之日起生效，在保险期间内如发生车辆转让，保险责任终止；车辆所有人或管理人应及时通知昌蓝（石家庄）科技有限公司变更手续，手续变更次日零时保险责任恢复，否则保险人不承担赔偿责任。保险期限：
        ...
        <tr>
          <td>
            <span>保险责任：</span
            >保险合同（保单号：6615402021130194000005）项下约定的责任，即保障范围内车辆被全车盗窃、抢劫、抢夺，经县级以上公安刑侦部门立案证实，满两个月未查明下落的，保险人根据保险合同约定进行赔偿。
          </td>
        </tr>
        <tr>
          <td>
            <span>赔偿处理：</span>
            <br />1.出险摩托车未从其他途径获得赔付的，本保险按被盗车辆折旧后价格的100%进行赔偿；出险摩托车已从其他途径获得赔付的前提下，本保险在赔偿限额内进行差额赔付。折旧率计算方法参照中国人寿财产保险股份有限公司机动车辆保险对应的摩托车车辆种类或型号和折旧率。
            <br />
            2.我公司确认索赔单证齐全有效后20个工作日内支付赔款。获取赔款后，运营商及车主应协助我公司向责任者进行追偿。本保险赔偿限额最高为<span
              class="underline"
              >{{ policy.carOrigPrice }}</span
            >元。
        ...
        <tr>
          <td>
            <span>有关义务：</span>
            <br />发生摩托车全车被盗抢后，车辆所有人应在24小时内向当地公安机关报案。车辆被盗后应当通过昌蓝（石家庄）科技有限公司向保险人索赔。索赔时，车主必须提供车辆保险单证复印件（包括交强险）、受损人驾驶证及身份证复印件、机动车行驶证、机动车登记证书、购车原始发票、车辆购置税完税证明（车辆购置附加费缴费证明）或免税证明、产品保修卡、保险证明（全车盗抢综合保险客户服务单）、被盗抢摩托车的全套钥匙、公安机关立案证明机动车所有权权益转让书（由车主向中国人寿财险河北分公司转让）、保险人要求的其他材料。
          </td>
        </tr>
        <tr>
          <td>
            ...
            1、非全车遭受盗抢，仅车上零部件或附属设备被盗抢、被损坏；2、被他人诈骗造成全车或部分损失；3、车主因违反政府有关法律、法规，车辆被有关国家机关罚没、扣押；4、车主因与他人的民事、经济纠纷而被抢劫、抢夺；5、租赁车辆与承租人同时失踪；6、车主的故意行为；7、客户违反本产品中规定的操作规程或擅自拆卸等引起的损失；8、除保险责任外的其他一切责任；
          </td>
        </tr>
        <tr>
          <td>
            ...
            <div style="display:flex;justify-content:space-between">
              <span>保险服务咨询：0311-95519</span>
              <span>服务商：昌蓝（石家庄）科技有限公司</span>
              <span>咨询电话：400-600-6861</span>
            </div>
          </td>
        </tr>
      </table>
      ...
      <div>
        注：1、本产品责任保险由昌蓝（石家庄）科技有限公司投保，中国人寿财产保险股份有限公司石家庄中心支公司承保。购买和安装昌蓝（石家庄）科技有限公司销售的北斗/GPS智能车载终端设备的摩托车可获得保险保障，本客户服务单仅作为服务凭证，在服务期限内，如需过户、换车、退费等变更事宜请联系服务商办理，保险公司不接受任何退费要求。
        <br />2、北斗/GPS智能车载终端自安装之日起保修三十六个月，如产品在保修期内出现故障，经告知，但用户未到指定部门维修，后果自负。
      ...
      <div class="new-content">
        ...
        <div class="tab-item1" style="margin-left:30px">
          <span>保单号：6615402021130194000005</span><br />
          <span>NO：{{ policy.policyId }}</span>
        </div>
        <div class="foot-content">
          <div class="seal-logo2">
            <img src="@/assets/img/insurance/changlan.png" />
          </div>
          <p>1、自承保之日起不再计算折旧。</p>
          <p>
          ...
          <p>3、以上特别约定由昌蓝（石家庄）科技有限公司先行赔付。</p>
          <p>4、昌蓝（石家庄）科技有限公司凭有效单据向保险公司索赔。</p>
          <p>
            5、盗抢保障服务费：<span
              class="underline"
              style="font-weight:unset"
              >{{ policy.coverage }}</span
            >元，大写：<span class="underline" style="font-weight:unset"
              >{{ coverageStr }}圆整</span
            >
          </p>
        </div>
  ...
  methods: {
    ...
    exportInsurance() {
      ...
      ExportUtil.exportPdf(
        ...
        this.imei + "_昌蓝服务单-不含购置税(" + this.policy.policyId + ")"
      );
      setTimeout(() => {
    ...
    loadInsurance() {
      ...
      loadInsuranceInfo(data).then(res => {
        if (res.errCode == "200") {
          ...
          this.coverageStr = ExportUtil.intToChinese(this.policy.coverage);
        }
      });
    }
  },
