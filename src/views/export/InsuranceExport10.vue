    ...
    <div class="ztinfo-insurance" id="export_insurance">
      ...
      <table class="insurance-table" border="1">
        ...
        <tr>
          <td>新车购置价</td>
          <td class="t-center">
            人民币：<span>{{ policy.carOrigPrice }}</span
            >元
          </td>
          <td>盗抢服务费</td>
          <td colspan="6" class="t-center">
            人民币：<span>{{ policy.coverage }}</span
            >元
          </td>
        </tr>
        <tr>
          <td colspan="6">
            您安装使用的宇辰生车辆盗抢保障服务系统有关事项声明如下：
          </td>
        </tr>
        <tr>
          <td colspan="6">
            一、盗抢保障服务提供商：北京宇辰生文化传播有限公司
          </td>
        </tr>
        <tr>
          <td colspan="6">
        ...
        <tr>
          <td colspan="6">
            三、相关义务：发生全车被盗抢后，车辆所有人应在24小时内向当地公安机关报案。车辆被盗后应当通过北京宇辰生文化发展有限公司向保险人索赔。索赔时，车主必须提供车辆保险单证复印件（包括交强险）、受损人驾驶证及身份证复印件、机动车行驶证、机动车登记证书、购车原始发票、车辆购置税完税证明（车辆购置附加费缴费证明）或免税证明、保障服务凭证（车辆盗抢保障服务凭证）、被盗抢车辆的全套钥匙、公安机关立案证明、被盗抢车辆状态证明、其他要求的材料。
          </td>
        </tr>
        <tr>
          <td colspan="6">
            本人(公司)已知悉并接受本服务凭证中的各项内容。经宇辰生明确说明，本人(公司)已了解责任免除条款的内容。
          </td>
        </tr>
        <tr>
          <td colspan="6">
        ...
        <tr>
          <td colspan="6">
            <div class="content-flex">
              <!-- <span>产品服务运营商：北京宇辰生文化发展有限公司</span> -->
              <span>产品服务运营商：北京宇辰生文化传播有限公司</span>
              <span>服务电话：4006008987</span>
            </div>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="6">
            <!-- 一、保 单 号：10560003901248221154 -->
            <!-- 一、保 单 号：10560003901283011086 -->
        ...
        <tr>
          <td colspan="6">
            三、标的车辆：在中华人民共和国境内（港、澳、台除外），安装使用了宇辰生RIDEBOX车辆盗抢保障服务管理系统的车辆，且车辆均为上牌车、正规车辆、在车管所有备案车辆。投保人向我司投保后，在保险期内，如果发生车辆转让情况，必须办理更名过户手续，自过户手续完成次日起，新车主可继续享有盗抢保障服务，保险责任在首次全车被盗抢发生且无法找回，保险人理赔结束后自动终止。
          </td>
        </tr>
        <tr>
          <td colspan="6">
            四、保险责任：在中华人民共和国境内（港、澳、台除外），安装了GPS北斗定位终端系列GPS定位防盗系统和护车星系列车辆管理服务系统的车辆，由于被保险人所提供的管理服终端存在缺陷导致全车被盗抢，经县以上公安刑侦部门立案证实，满二个月未查明下落的，保险人赔偿限额内按照保险合同约定内容负责赔偿。单车赔偿限额为保险人对单一车辆损失承担的最高赔偿限额，并且不超过受损车辆新车购置价减去车辆已使用年限对应折旧的金额，承保GPS需保证可正常运行。
          </td>
        </tr>
        <tr>
          <td colspan="6">
        ...
        <tr>
          <td colspan="6">
            六、赔偿处理：发生保险责任范围内的损失时，由北京宇辰生文化发展有限公司按约定赔付标准赔付，签署权益转让书后保险人可在收到权益转让书后，在约定的赔偿限额内赔付。
          </td>
        </tr>
        <tr>
          <td colspan="6">
  ...
  methods: {
    exportInsurance() {
      ...
      ExportUtil.exportPdf(
        ...
        this.imei + "_摩托车车辆盗抢保障服务(" + this.policy.policyId + ")"
      );
      setTimeout(() => {
