<template>
  <div :id="'open_baidu_' + mapName" style="height: 100%; width: 100%">
...
export default {
  ...
  methods: {
    ...
    initMap() {
      console.log(`open_baidu_${this.mapName}`);
      let map = L.map(`open_baidu_${this.mapName}`, {
        crs: L.CRS.Baidu,
